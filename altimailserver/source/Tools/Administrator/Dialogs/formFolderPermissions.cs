...
namespace AltimailServer.Administrator.Dialogs
{
   ...
   {
      private AltimailServer.IMAPFolder _folder;

      public formFolderPermissions(AltimailServer.IMAPFolder folder)
      {
         InitializeComponent();
      ...
      private void ListPermissions()
      {
         ...
         AltimailServer.IMAPFolderPermissions permissions = _folder.Permissions;

         for (int i = 0; i < permissions.Count; i++)
         {
            AltimailServer.IMAPFolderPermission permission = permissions[i];
      ...
      private AltimailServer.Groups GetGroups()
      {
      ...
      private string GetPermissionName(AltimailServer.IMAPFolderPermission permission)
      {
         ...
         switch (permission.PermissionType)
         {
            case eACLPermissionType.ePermissionTypeUser:
               {
                  AltimailServer.Account account = permission.Account;
                  name = account.Address;
                  break;
               }
            case eACLPermissionType.ePermissionTypeGroup:
               {
                  AltimailServer.Group group = permission.Group;
                  name = group.Name;
                  break;
               }
      ...
      private ListViewItem ListPermission(AltimailServer.IMAPFolderPermission permission)
      {
         string name = "<Deleted>";
      ...
      private void SaveRightsForPermission()
      {
         ...
         AltimailServer.IMAPFolderPermission permission = listACL.SelectedItems[0].Tag as AltimailServer.IMAPFolderPermission;
      ...
      private void buttonDeleteWhiteList_Click(object sender, EventArgs e)
      {
         ...
         {
            AltimailServer.IMAPFolderPermission permission = item.Tag as AltimailServer.IMAPFolderPermission;
