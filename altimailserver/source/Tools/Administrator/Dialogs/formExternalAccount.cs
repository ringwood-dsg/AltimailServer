...
namespace AltimailServer.Administrator.Dialogs
{
   ...
   {
      private AltimailServer.FetchAccount _fetchAccount = null;
      ...
      public void LoadAccountProperties(AltimailServer.FetchAccount fetchAccount)
      {
         _isLoading = true;
      ...
      public void SaveAccountProperties(AltimailServer.FetchAccount fetchAccount)
      {
