namespace AltimailServer.Administrator.Dialogs
{
   partial class formExternalAccount
   {
      ...
      private void InitializeComponent()
      {
            ...
            this.checkEnableRouteRecipients = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.checkUseAntiSpam = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.checkUseAntiVirus = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.textPassword = new AltimailServer.Administrator.Controls.ucPassword();
            this.textDaysToKeepMessages = new AltimailServer.Shared.ucText();
            this.radioNeverDeleteMessages = new AltimailServer.Administrator.Controls.ucRadioButton();
            this.radioDeleteMessagesAfter = new AltimailServer.Administrator.Controls.ucRadioButton();
            this.radioDeleteImmediately = new AltimailServer.Administrator.Controls.ucRadioButton();
            this.textMIMERecipientHeaders = new AltimailServer.Shared.ucText();
            this.checkProcessMIMEDate = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.checkProcessMIMERecipients = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.textMinutesBetweenFetch = new AltimailServer.Shared.ucText();
            this.textUsername = new AltimailServer.Shared.ucText();
            this.textPort = new AltimailServer.Shared.ucText();
            this.textServer = new AltimailServer.Shared.ucText();
            this.comboServerType = new AltimailServer.Administrator.Controls.ucComboBox();
      ...
      private AltimailServer.Administrator.Controls.ucComboBox comboServerType;
      private System.Windows.Forms.Label labelPassword;
      private AltimailServer.Shared.ucText textUsername;
      private System.Windows.Forms.Label labelUsername;
      private AltimailServer.Shared.ucText textPort;
      private System.Windows.Forms.Label labelTCPIPPort;
      private AltimailServer.Shared.ucText textServer;
      private System.Windows.Forms.Label labelServerAddress;
      private System.Windows.Forms.Label labelSettings;
      private AltimailServer.Shared.ucText textMinutesBetweenFetch;
      private System.Windows.Forms.Label labelMinutesBetweenDownload;
      private AltimailServer.Shared.ucText textMIMERecipientHeaders;
      private System.Windows.Forms.Label labelMIMERecipientHeaders;
      private AltimailServer.Administrator.Controls.ucCheckbox checkProcessMIMERecipients;
      private AltimailServer.Administrator.Controls.ucCheckbox checkProcessMIMEDate;
      private AltimailServer.Administrator.Controls.ucRadioButton radioDeleteImmediately;
      private AltimailServer.Administrator.Controls.ucRadioButton radioDeleteMessagesAfter;
      private AltimailServer.Administrator.Controls.ucRadioButton radioNeverDeleteMessages;
      private AltimailServer.Shared.ucText textDaysToKeepMessages;
      ...
      private AltimailServer.Administrator.Controls.ucCheckbox checkUseAntiSpam;
      private AltimailServer.Administrator.Controls.ucCheckbox checkUseAntiVirus;
      private AltimailServer.Administrator.Controls.ucCheckbox checkEnableRouteRecipients;
