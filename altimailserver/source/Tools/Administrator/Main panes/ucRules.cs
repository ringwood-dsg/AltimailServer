...
namespace AltimailServer.Administrator
{
   ...
   {
      private AltimailServer.Rules _rulesCollection;
      ...
      public void LoadRules(AltimailServer.Rules rulesCollection)
      {
      ...
      private void ListRules()
      {
         ...
         {
            AltimailServer.Rule rule = _rulesCollection[i];
      ...
      {
         AltimailServer.Rule rule = _rulesCollection.Add();
      ...
      private void EditSelectedItem()
      {
         ...
         AltimailServer.Rule rule = _rulesCollection.get_ItemByDBID(id);
