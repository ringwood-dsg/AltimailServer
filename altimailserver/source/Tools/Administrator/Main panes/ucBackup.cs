...
namespace AltimailServer.Administrator
{
   ...
   {
      private AltimailServer.Backup _backup;
      ...
      public void LoadData()
      {
         ...
         AltimailServer.BackupSettings backupSettings = settings.Backup;
      ...
      {
         AltimailServer.BackupSettings backupSettings = APICreator.Application.Settings.Backup;
