...
namespace AltimailServer.Administrator
{
   public partial class ucAntiVirus : UserControl, ISettingsControl
   {
      ...
      public void LoadData()
      {
         ...
         AltimailServer.AntiVirus antiVirusSettings = settings.AntiVirus;
      ...
      private void ListBlockedAttachments()
      {
         ...
         AltimailServer.AntiVirus antiVirusSettings = settings.AntiVirus;
         AltimailServer.BlockedAttachments attachments = antiVirusSettings.BlockedAttachments;

         for (int i = 0; i < attachments.Count; i++)
         {
            AltimailServer.BlockedAttachment attachment = attachments[i];
      ...
      private void buttonAddBlockedAttachment_Click(object sender, EventArgs e)
      {
         ...
         if (blockedDlg.ShowDialog() == DialogResult.OK)
         {
            ...
            AltimailServer.BlockedAttachment ba = attachments.Add();
      ...
      private void EditSelectedBlockedAttachment()
      {
         ...
         AltimailServer.AntiVirus antiVirusSettings = settings.AntiVirus;
         AltimailServer.BlockedAttachments attachments = antiVirusSettings.BlockedAttachments;
         AltimailServer.BlockedAttachment ba = attachments.get_ItemByDBID(id);
