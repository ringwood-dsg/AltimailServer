...
namespace AltimailServer.Administrator
{
   ...
   {
      private AltimailServer.Route _representedObject;
      ...
      private void buttonAddRecipient_Click(object sender, EventArgs e)
      {
         ...
         if (inputDialog.ShowDialog() == DialogResult.OK)
         {
            ...
            AltimailServer.RouteAddresses routeAddresses = _representedObject.Addresses;
            AltimailServer.RouteAddress routeAddress = routeAddresses.Add();
      ...
      private void ListRecipients()
      {
         ...
         {
            AltimailServer.RouteAddress address = routeAddresses[i];
      ...
      private void buttonDeleteWhiteList_Click(object sender, EventArgs e)
      {
         ...
         {
            AltimailServer.RouteAddress address = item.Tag as AltimailServer.RouteAddress;
            address.Delete();
         }
