...
namespace AltimailServer.Administrator
{
   public partial class ucStatus : UserControl, ISettingsControl
   {
      ...
      private AltimailServer.Logging _logging = null;
      ...
      public void LoadData()
      {
         ...
         AltimailServer.Settings settings = _application.Settings;
      ...
      private void DisplayWarnings()
      {
         ...
         AltimailServer.SecurityRanges ranges = settings.SecurityRanges;
         for (int i = 0; i < ranges.Count; i++)
         {
            AltimailServer.SecurityRange range = ranges[i];
      ...
      private void btnClearQueue_Click(object sender, EventArgs e)
      {
         ...
         if (MessageBox.Show(message, EnumStrings.hMailServerAdministrator, MessageBoxButtons.YesNo) == DialogResult.Yes)
         {
            ...
            AltimailServer.DeliveryQueue deliveryQueue = GetDeliveryQueue();
            deliveryQueue.Clear();
      ...
      private AltimailServer.DeliveryQueue GetDeliveryQueue()
      {
         AltimailServer.GlobalObjects globalObjects = _application.GlobalObjects;

         AltimailServer.DeliveryQueue deliveryQueue = globalObjects.DeliveryQueue;
