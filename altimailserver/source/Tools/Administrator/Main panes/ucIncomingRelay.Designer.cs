namespace AltimailServer.Administrator
{
    partial class ucIncomingRelay
    {
        ...
        private void InitializeComponent()
        {
         ...
         this.textLower = new AltimailServer.Administrator.Controls.ucIPAddress();
         this.textUpper = new AltimailServer.Administrator.Controls.ucIPAddress();
         this.SuspendLayout();
         // 
         // labelUpperIP
         // 
        ...
        private AltimailServer.Administrator.Controls.ucIPAddress textLower;
        private AltimailServer.Administrator.Controls.ucIPAddress textUpper;
    }
}
