...
namespace AltimailServer.Administrator
{
    partial class ucStatus
    {
        ...
        private void InitializeComponent()
        {
           ...
           this.textIMAPSessions = new AltimailServer.Shared.ucText();
           this.textPOP3Sessions = new AltimailServer.Shared.ucText();
           this.textSMTPSessions = new AltimailServer.Shared.ucText();
           this.textMessagesContainingSpam = new AltimailServer.Shared.ucText();
           this.textMessagesContainingViruses = new AltimailServer.Shared.ucText();
           this.textProcessedMessages = new AltimailServer.Shared.ucText();
       ...
       private System.Windows.Forms.Button buttonStartStop;
        ...
        private AltimailServer.Shared.ucText textIMAPSessions;
        private AltimailServer.Shared.ucText textPOP3Sessions;
        private AltimailServer.Shared.ucText textSMTPSessions;
        private AltimailServer.Shared.ucText textMessagesContainingSpam;
        private AltimailServer.Shared.ucText textMessagesContainingViruses;
        private AltimailServer.Shared.ucText textProcessedMessages;
