namespace AltimailServer.Administrator
{
   partial class ucAutoBan
   {
      ...
      {
            this.checkAutoBanOnLogonFailure = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.labelMaxInvalidLogonAttempts = new System.Windows.Forms.Label();
            this.textMaxInvalidLogonAttempts = new AltimailServer.Shared.ucText();
            this.labelMaxInvalidLogonAttemptsWithin = new System.Windows.Forms.Label();
            this.textMaxInvalidLogonAttemptsWithin = new AltimailServer.Shared.ucText();
            this.labelAutoBanMinutes = new System.Windows.Forms.Label();
            this.textAutoBanMinutes = new AltimailServer.Shared.ucText();
            ...
            this.checkAutoBanOnLogonFailure.FlatStyle = System.Windows.Forms.FlatStyle.System;
            ...
            this.checkAutoBanOnLogonFailure.Size = new System.Drawing.Size(71, 18);
            ...
            this.textMaxInvalidLogonAttempts.Number64 = ((long)(0));
            ...
            this.textMaxInvalidLogonAttemptsWithin.Number64 = ((long)(0));
            ...
            this.textAutoBanMinutes.Number64 = ((long)(0));
    ...
    "locked, if too many invalid logon attempts are made on it.";
      ...
      private AltimailServer.Administrator.Controls.ucCheckbox checkAutoBanOnLogonFailure;
      private System.Windows.Forms.Label labelMaxInvalidLogonAttempts;
      private AltimailServer.Shared.ucText textMaxInvalidLogonAttempts;
      private System.Windows.Forms.Label labelMaxInvalidLogonAttemptsWithin;
      private AltimailServer.Shared.ucText textMaxInvalidLogonAttemptsWithin;
      private System.Windows.Forms.Label labelAutoBanMinutes;
      private AltimailServer.Shared.ucText textAutoBanMinutes;
