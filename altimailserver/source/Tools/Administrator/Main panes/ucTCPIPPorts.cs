...
namespace AltimailServer.Administrator
{
   public partial class ucTCPIPPorts : ucItemsView
   {
      ...
      {
         if (MessageBox.Show(Strings.Localize("This operation will change the configuration of the TCP/IP ports to their default values. Are you sure you want to do this?"), EnumStrings.AltimailServerAdministrator, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
         {
