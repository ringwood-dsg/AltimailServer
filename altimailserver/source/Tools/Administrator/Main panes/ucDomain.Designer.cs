namespace AltimailServer.Administrator
{
   partial class ucDomain
   {
      ...
      private void InitializeComponent()
      {
            ...
            this.textDomainName = new AltimailServer.Shared.ucText();
            ...
            this.listAliases = new AltimailServer.Administrator.ucListView();
            this.columnHeader1 = ((System.Windows.Forms.ColumnHeader)(new System.Windows.Forms.ColumnHeader()));
            this.buttonRemove = new System.Windows.Forms.Button();
            this.tabPageSignature = new System.Windows.Forms.TabPage();
            this.textHTMLSignature = new AltimailServer.Shared.ucText();
            this.labelHTMLSignature = new System.Windows.Forms.Label();
            this.labelPlainTextSignature = new System.Windows.Forms.Label();
            this.textPlainTextSignature = new AltimailServer.Shared.ucText();
            this.radioSMAppendToAccountSignature = new AltimailServer.Administrator.Controls.ucRadioButton();
            this.radioSMOverwriteAccountSignature = new AltimailServer.Administrator.Controls.ucRadioButton();
            this.radioSMSetIfNotSpecifiedInAccount = new AltimailServer.Administrator.Controls.ucRadioButton();
            this.checkSignatureEnabled = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.checkAddSignaturesToLocalMail = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.checkAddSignaturesToReplies = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.tabPageLimits = new System.Windows.Forms.TabPage();
            this.textMaxNumberOfDistributionLists = new AltimailServer.Shared.ucText();
            ...
            this.textMaxNumberOfAliases = new AltimailServer.Shared.ucText();
            this.textMaxNumberOfAccounts = new AltimailServer.Shared.ucText();
            this.textMaxAccountSize = new AltimailServer.Shared.ucText();
            this.textMaxMessageSize = new AltimailServer.Shared.ucText();
            this.textAllocatedSize = new AltimailServer.Shared.ucText();
            this.textMaxSize = new AltimailServer.Shared.ucText();
            this.checkMaxNumberOfDistributionListsEnabled = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.checkMaxNumberOfAliasesEnabled = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.checkMaxNumberOfAccountsEnabled = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.tabPageDKIM = new System.Windows.Forms.TabPage();
            this.buttonSelectCertificate = new System.Windows.Forms.Button();
            this.panel3 = new System.Windows.Forms.Panel();
            this.radioDKIMSigningAlgorithmSHA256 = new AltimailServer.Administrator.Controls.ucRadioButton();
            this.radioDKIMSigningAlgorithmSHA1 = new AltimailServer.Administrator.Controls.ucRadioButton();
            this.panel2 = new System.Windows.Forms.Panel();
            this.radioDKIMBodyMethodRelaxed = new AltimailServer.Administrator.Controls.ucRadioButton();
            this.radioDKIMBodyMethodSimple = new AltimailServer.Administrator.Controls.ucRadioButton();
            this.panel1 = new System.Windows.Forms.Panel();
            this.radioDKIMHeaderMethodRelaxed = new AltimailServer.Administrator.Controls.ucRadioButton();
            this.radioDKIMHeaderMethodSimple = new AltimailServer.Administrator.Controls.ucRadioButton();
            ...
            this.textDKIMSelector = new AltimailServer.Shared.ucText();
            this.labelDKIMPrivateKeyFile = new System.Windows.Forms.Label();
            this.textDKIMPrivateKeyFile = new AltimailServer.Shared.ucText();
            this.checkDKIMSignEnabled = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.checkDKIMSignAliasesEnabled = new AltimailServer.Administrator.Controls.ucCheckbox();
            this.tabPageAdvanced = new System.Windows.Forms.TabPage();
            this.textCatchAllAddress = new AltimailServer.Administrator.Controls.ucEmailEdit();
            this.labelCatchAll = new System.Windows.Forms.Label();
            this.comboPlusAddressingCharacter = new AltimailServer.Administrator.Controls.ucComboBox();
            this.checkGreyListingEnabled = new AltimailServer.Administrator.Controls.ucCheckbox();
            ...
            this.checkUsePlusAddressing = new AltimailServer.Administrator.Controls.ucCheckbox();
            ...
            this.listAliases.HideSelection = false;
            ...
            this.textHTMLSignature.Number64 = ((long)(0));
            ...
            this.textPlainTextSignature.Number64 = ((long)(0));
            ...
            this.textMaxNumberOfDistributionLists.Number64 = ((long)(0));
            ...
            this.textMaxNumberOfAliases.Number64 = ((long)(0));
            ...
            this.textMaxNumberOfAccounts.Number64 = ((long)(0));
            ...
            this.textMaxAccountSize.Number64 = ((long)(0));
            ...
            this.textAllocatedSize.Number64 = ((long)(0));
            ...
            this.textMaxSize.Number64 = ((long)(0));
            ...
            this.textDKIMSelector.Number64 = ((long)(0));
            ...
            this.textDKIMPrivateKeyFile.Number64 = ((long)(0));
      ...
      private AltimailServer.Shared.ucText textDomainName;
      private System.Windows.Forms.Label labelDomain;
      private System.Windows.Forms.Button buttonAdd;
      private System.Windows.Forms.Button buttonRemove;
      private AltimailServer.Administrator.Controls.ucRadioButton radioSMAppendToAccountSignature;
      private AltimailServer.Administrator.Controls.ucRadioButton radioSMOverwriteAccountSignature;
      private AltimailServer.Administrator.Controls.ucRadioButton radioSMSetIfNotSpecifiedInAccount;
      private AltimailServer.Administrator.Controls.ucCheckbox checkSignatureEnabled;
      private AltimailServer.Administrator.Controls.ucCheckbox checkAddSignaturesToLocalMail;
      private AltimailServer.Administrator.Controls.ucCheckbox checkAddSignaturesToReplies;
      private System.Windows.Forms.Label labelPlainTextSignature;
      private AltimailServer.Shared.ucText textHTMLSignature;
      private System.Windows.Forms.Label labelHTMLSignature;
      private AltimailServer.Shared.ucText textPlainTextSignature;
      private AltimailServer.Shared.ucText textMaxAccountSize;
      private System.Windows.Forms.Label lblMaxAccountSize;
      private AltimailServer.Shared.ucText textMaxMessageSize;
      private System.Windows.Forms.Label lblMaxMessageSize;
      private AltimailServer.Shared.ucText textAllocatedSize;
      private AltimailServer.Shared.ucText textMaxSize;
      private System.Windows.Forms.Label lblAllocatedSize;
      private System.Windows.Forms.Label labelMaxSize;
      private AltimailServer.Shared.ucText textMaxNumberOfAliases;
      private System.Windows.Forms.Label lblMaxNoOfAliases;
      private AltimailServer.Administrator.Controls.ucCheckbox checkMaxNumberOfAliasesEnabled;
      private AltimailServer.Shared.ucText textMaxNumberOfAccounts;
      private System.Windows.Forms.Label lblMaxNoOfAccounts;
      private AltimailServer.Administrator.Controls.ucCheckbox checkMaxNumberOfAccountsEnabled;
      private AltimailServer.Shared.ucText textMaxNumberOfDistributionLists;
      private System.Windows.Forms.Label lblMaxNoOfDistributionLists;
      private AltimailServer.Administrator.Controls.ucCheckbox checkMaxNumberOfDistributionListsEnabled;
      private AltimailServer.Administrator.Controls.ucCheckbox checkGreyListingEnabled;
      private System.Windows.Forms.Label labelPlusAddressingCharacter;
      private AltimailServer.Administrator.Controls.ucCheckbox checkUsePlusAddressing;
      private System.Windows.Forms.Label labelPlusAddressing;
      private AltimailServer.Administrator.Controls.ucComboBox comboPlusAddressingCharacter;
      private ucListView listAliases;
      private System.Windows.Forms.ColumnHeader columnHeader1;
      private System.Windows.Forms.Button buttonEdit;
      private AltimailServer.Administrator.Controls.ucCheckbox checkEnabled;
      private AltimailServer.Administrator.Controls.ucEmailEdit textCatchAllAddress;
      ...
      private AltimailServer.Shared.ucText textDKIMSelector;
      private System.Windows.Forms.Label labelDKIMPrivateKeyFile;
      private AltimailServer.Shared.ucText textDKIMPrivateKeyFile;
      private AltimailServer.Administrator.Controls.ucCheckbox checkDKIMSignEnabled;
      private AltimailServer.Administrator.Controls.ucCheckbox checkDKIMSignAliasesEnabled;
      ...
      private AltimailServer.Administrator.Controls.ucRadioButton radioDKIMBodyMethodRelaxed;
      private AltimailServer.Administrator.Controls.ucRadioButton radioDKIMBodyMethodSimple;
      private AltimailServer.Administrator.Controls.ucRadioButton radioDKIMHeaderMethodRelaxed;
      private AltimailServer.Administrator.Controls.ucRadioButton radioDKIMHeaderMethodSimple;
      private AltimailServer.Administrator.Controls.ucRadioButton radioDKIMSigningAlgorithmSHA256;
      private AltimailServer.Administrator.Controls.ucRadioButton radioDKIMSigningAlgorithmSHA1;
