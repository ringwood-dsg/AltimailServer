...
namespace AltimailServer.Administrator
{
   public partial class ucAccount : UserControl, ISettingsControl
   {
      ...
      private AltimailServer.Account _representedAccount = null;
      ...
      public bool SaveData()
      {
         ...
         _representedAccount.AdminLevel = (AltimailServer.eAdminLevel)comboAdministrationLevel.SelectedValue;
      ...
      private void buttonAddExternalAccount_Click(object sender, EventArgs e)
      {
         ...
         {
            AltimailServer.FetchAccounts fetchAccounts = _representedAccount.FetchAccounts;
            AltimailServer.FetchAccount fetchAccount = _representedAccount.FetchAccounts.Add();
      ...
      private void ListExternalAccounts()
      {
         ...
         {
            AltimailServer.FetchAccount fetchAccount = fetchAccounts.get_Item(i);
      ...
      private void EditSelectedExternalAccount()
      {
         ...
         AltimailServer.FetchAccounts fetchAccounts = _representedAccount.FetchAccounts;
         AltimailServer.FetchAccount fetchAccount = fetchAccounts.get_ItemByDBID(id);
