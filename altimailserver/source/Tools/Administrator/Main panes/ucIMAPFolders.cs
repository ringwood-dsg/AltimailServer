...
namespace AltimailServer.Administrator
{
   ...
   {
      private AltimailServer.IMAPFolders _folders;
      ...
      public bool SaveCurrentFolder()
      {
         ...
         if (currentNode != null)
         {
            AltimailServer.IMAPFolder folder = currentNode.Tag as AltimailServer.IMAPFolder;
      ...
      public void LoadProperties(AltimailServer.IMAPFolders imapFolders, bool publicFolders)
      {
         ...
         {
            AltimailServer.IMAPFolder folder = _folders[i];
      ...
      private void LoadSubFolders(AltimailServer.IMAPFolder folder, TreeNode node)
      {
         AltimailServer.IMAPFolders folders = folder.SubFolders;

         for (int i = 0; i < folders.Count; i++)
         {
            AltimailServer.IMAPFolder subFolder = folders[i];
      ...
      private void ShowCurrentFolder()
      {
         ...
         AltimailServer.IMAPFolder folder = selectedNode.Tag as IMAPFolder;
      ...
      private void btnEditPermissions_Click(object sender, EventArgs e)
      {
         ...
         AltimailServer.IMAPFolder folder = selectedNode.Tag as AltimailServer.IMAPFolder;
      ...
      private void createFolderToolStripMenuItem_Click(object sender, EventArgs e)
      {
         try
         {
            ...
            AltimailServer.IMAPFolder folder;
            if (selectedNode != null)
            {
               AltimailServer.IMAPFolder parentFolder = selectedNode.Tag as AltimailServer.IMAPFolder;
