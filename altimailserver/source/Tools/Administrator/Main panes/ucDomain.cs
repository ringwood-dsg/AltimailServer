...
namespace AltimailServer.Administrator
{
   ...
   {
      private AltimailServer.Domain _domain;
      private AltimailServer.Application _application;

      public ucDomain(AltimailServer.Domain domain)
      {
         InitializeComponent();
      ...
      public void LoadData()
      {
         ...
         checkDKIMSignAliasesEnabled.Checked = _domain.DKIMSignAliasesEnabled && _domain.DomainAliases.Count > 0;
         checkDKIMSignAliasesEnabled.Enabled = _domain.DomainAliases.Count > 0;
      ...
      public bool SaveData()
      {
         if (_domain == null)
         {
            AltimailServer.Domains domains = _application.Domains;
            _domain = domains.Add();
         ...
         _domain.DKIMSignAliasesEnabled = checkDKIMSignAliasesEnabled.Checked && _domain.DomainAliases.Count > 0;
      ...
      private void buttonAdd_Click(object sender, EventArgs e)
      {
         ...
         if (inputDialog.ShowDialog() == DialogResult.OK)
         {
            ...
            AltimailServer.DomainAliases domainAliases = _domain.DomainAliases;
      ...
      private void EditSelectedName()
      {
         ...
         DomainAliases domainAliases = _domain.DomainAliases;
         AltimailServer.DomainAlias da = domainAliases.get_ItemByDBID(id);
