...
namespace AltimailServer.Administrator
{
   public partial class ucDiagnostics : UserControl, ISettingsControl
   {
      ...
      private void buttonPerformTests_Click(object sender, EventArgs e)
      {
         ...
         {
            AltimailServer.Diagnostics diagnostics = APICreator.Application.Diagnostics;

            diagnostics.LocalDomainName = comboLocalDomain.Text;
            diagnostics.TestDomainName = textboxTestDomain.Text;

            AltimailServer.DiagnosticResults results = diagnostics.PerformTests();
      ...
      private void DisplayResults(AltimailServer.DiagnosticResults results)
      {
         ...
         {
            AltimailServer.DiagnosticResult result = results.get_Item(i);
