...
namespace DBSetupQuick
{
   static class Program
   {
      ...
      static void Main()
      {
         ...
         _application = new AltimailServer.Application();
      ...
      private static void CreateDatabase()
      {
         ...
         if (_application.Database.DatabaseType == AltimailServer.eDBtype.hDBTypeMSSQLCE ||
             _application.Database.DatabaseType == AltimailServer.eDBtype.hDBTypeUnknown)
         {
