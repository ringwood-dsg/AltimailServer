namespace DBSetup.Pages
{
   partial class ucAction
   {
      ...
      private void InitializeComponent()
      {
            ...
            this.radioCreateNew.Size = new System.Drawing.Size(220, 17);
            this.radioCreateNew.TabIndex = 0;
            this.radioCreateNew.TabStop = true;
            this.radioCreateNew.Text = "Create a new Altimail Server database.";
            ...
            this.radioSelectNew.Size = new System.Drawing.Size(295, 17);
            this.radioSelectNew.TabIndex = 1;
            this.radioSelectNew.Text = "Use an existing Altimail Server/hMailServer database.";
            this.radioSelectNew.UseVisualStyleBackColor = true;
            // 
            // labelCreateNewHelp
            // 
            this.labelCreateNewHelp.Font = new System.Drawing.Font("Segoe UI", 7.5F);
            this.labelCreateNewHelp.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(48)))), ((int)(((byte)(48)))), ((int)(((byte)(48)))));
            this.labelCreateNewHelp.Location = new System.Drawing.Point(26, 30);
            this.labelCreateNewHelp.Name = "labelCreateNewHelp";
            this.labelCreateNewHelp.Size = new System.Drawing.Size(431, 30);
            this.labelCreateNewHelp.TabIndex = 2;
            this.labelCreateNewHelp.Text = "Select this option if you are new to Altimail Server and require a new database. " +
    "The database should not already exist!";
            ...
            this.label1.Text = "Select this option to use an existing Altimail Server, or hMailServer, database. " +
    "Any required upgrades will be performed automatically.";
            // 
            // ucAction
            // 
