...
#define XALTIMAILSERVER_LOOPCOUNT _T("X-AltimailServer-LoopCount")
...
namespace HM
{
   ...
   {
      String sRulesProcessed = mime_mail_->GetRawFieldValue(XALTIMAILSERVER_LOOPCOUNT);
   ...
   {
      mime_mail_->SetRawFieldValue(XALTIMAILSERVER_LOOPCOUNT, StringParser::IntToString(iLoopCount), "");
   }
