...
namespace HM
{
   ...
   {
      ErrorManager::Instance()->ReportError(ErrorManager::High, 5143, "TCPServer::GetPassword()", "The private key file has a password. Altimail Server does not support this.");
      return "";
   }
