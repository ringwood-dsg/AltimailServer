...
#define ALTIMAILSERVER_VERSION_NUMERIC 6,0,0,2602
#define ALTIMAILSERVER_BUILD "2602.8" /*YYMM.BUILD_NO where BUILD_NO is always incremented with each build/release.*/
/*
[list=1]
