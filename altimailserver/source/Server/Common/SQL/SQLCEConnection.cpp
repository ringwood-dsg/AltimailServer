   ...
   SQLCEConnection::Connect(String &sErrorMessage)
   {
      ...
      */
      ...
      catch ( _com_error &err )
      {
         ...
         sErrorMessage.Format(_T("Database connection error. Source: %s, Error: %d, Description: %s Check database settings in AltimailServer.ini."), sErrSource.c_str(), iNativeErrorCode, sErrDesc.c_str());
      ...
      catch( ... )
      {
         ...
         ErrorManager::Instance()->ReportError(ErrorManager::Critical, 5099, "SQLCEConnection::Connect", "An unknown error occurred when connecting to database. Check your database settings in AltimailServer.ini.");
