...
namespace HM
{
   ...
   ADOConnection::Connect(String &sErrorMessage)
   {
      ...
      catch ( _com_error &err )
      {
         ...
         String sMessage = "Error when connecting to database. " + sErrSource + " " + sErrDesc + " Check your database settings in AltimailServer.ini.";
      ...
      catch( ... )
      {
         ...
         ErrorManager::Instance()->ReportError(ErrorManager::Critical, 5029, "ADOConnection::Connect", "An unknown error occurred when connecting to database. Check your database settings in AltimailServer.ini.");
