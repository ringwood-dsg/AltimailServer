...
namespace HM
{
   class CAltimailServerModule : public CAtlExeModuleT<CAltimailServerModule>
   {
   public:
      DECLARE_LIBID(LIBID_AltimailServer)
      DECLARE_REGISTRY_APPID_RESOURCEID(IDR_ALTIMAILSERVER, "{0CFF9C0A-CC57-4D92-9C21-E0842990831E}")
         ...
         RegisterObjects()
      {
         ...
         if (FAILED(hr))
         {
            ...
            ErrorManager::Instance()->ReportError(ErrorManager::Medium, 5078, "AltimailServer::RegisterObjects", sErrorMessage);
         ...
         if (FAILED(hr))
         {
            ...
            ErrorManager::Instance()->ReportError(ErrorManager::Medium, 5079, "AltimailServer::RegisterObjects", sErrorMessage);
         ...
         ResumeObjects()
      {
         ...
         if (FAILED(hr))
         {
            ...
            ErrorManager::Instance()->ReportError(ErrorManager::Medium, 5080, "AltimailServer::ResumeObjects", sErrorMessage);
         ...
         //------------------------------------------------------------------------//
      {
         ...
         key.SetStringValue(_T("LocalService"), _T("AltimailServer"));
         if (lRes != ERROR_SUCCESS)
            return AtlHresultFromWin32(lRes);
...
HM::CAltimailServerModule _AtlModule;
   ...
   LPTSTR lpCmdLine, int nShowCmd)
{
   ...
   if (bRegisterService)
   {
      // --- Register the AltimailServer service.
      HM::ServiceManager hSCM;
      if (!hSCM.RegisterService("AltimailServer", "AltimailServer"))
      {
         return -1;
      }
   }
   ...
   if (sLastParam.CompareNoCase(_T("/Unregister")) == 0)
   {
      ...
      HM::ServiceManager hSCM;
      hSCM.UnregisterService("AltimailServer");
...
//------------------------------------------------------------------------//
{
   ...
   ServiceStatusHandle = RegisterServiceCtrlHandler(_T("AltimailServer"), ServiceController);
