// Copyright (c) 2006 Martin Knafve / altimailserver.org.  
...
class ATL_NO_VTABLE InterfaceIMAPFolders : 
	...
	public IDispatchImpl<IInterfaceIMAPFolders, &IID_IInterfaceIMAPFolders, &LIBID_AltimailServer, /*wMajor =*/ 1, /*wMinor =*/ 0>,
