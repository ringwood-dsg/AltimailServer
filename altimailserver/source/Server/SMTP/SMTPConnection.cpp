...
namespace HM
{
   ...
   SMTPConnection::OnPreAcceptTransfer_()
   {
      ...
      if (Configuration::Instance()->GetUseScriptServer())
      {
         ...
         pContainer->AddObject("ALTIMAILSERVER_MESSAGE", current_message_, ScriptObject::OTMessage);
         pContainer->AddObject("ALTIMAILSERVER_CLIENT", pClientInfo, ScriptObject::OTClient);
         pContainer->AddObject("Result", pResult, ScriptObject::OTResult);

         String sEventCaller = "OnAcceptMessage(ALTIMAILSERVER_CLIENT, ALTIMAILSERVER_MESSAGE)";
   ...
   SMTPConnection::ProtocolEHLO_(const String &sRequest)
   {
      ...
      if (Configuration::Instance()->GetUseScriptServer())
      {
         ...
         String sEventCaller = "OnHELO(ALTIMAILSERVER_CLIENT)";
   ...
   SMTPConnection::ProtocolDATA_()
   {
      ...
      if (Configuration::Instance()->GetUseScriptServer())
      {
         ...
         String sEventCaller = "OnSMTPData(ALTIMAILSERVER_CLIENT, ALTIMAILSERVER_MESSAGE)";
...
// WE SHOULD ADD SOME LOGGING HERE
   ...
   SMTPConnection::Authenticate_()
   {
      ...
      if (Configuration::Instance()->GetUseScriptServer())
      {
         ...
         String sEventCaller = "OnClientLogon(ALTIMAILSERVER_CLIENT)";
      ...
      if (iErrorCode >= 500 && iErrorCode <= 599)
      {
            ...
            cur_no_of_invalid_commands_ > Configuration::Instance()->GetMaximumIncorrectCommands())
         {
            ...
            if (Configuration::Instance()->GetUseScriptServer())
            {
               ...
               String sEventCaller = "OnTooManyInvalidCommands(ALTIMAILSERVER_CLIENT, ALTIMAILSERVER_MESSAGE)";
         ...
         else
         {
            if (!sResponse.compare(CONST_UNKNOWN_USER))
            {
               if (Configuration::Instance()->GetUseScriptServer())
               {
                  ...
                  String sEventCaller = "OnRecipientUnknown(ALTIMAILSERVER_CLIENT, ALTIMAILSERVER_MESSAGE)";
