...
namespace RegressionTests.SSL
{
   ...
   {
      public static void SetupSSLPorts(AltimailServer.Application application, SslVersions sslVersions = null)
      {
      ...
      private static SSLCertificate SetupSSLCertificate(AltimailServer.Application application)
      {
         var sslPath = GetSslCertPath();
