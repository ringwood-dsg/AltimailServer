...
namespace RegressionTests.Shared
{
   public class TestSetup
   {
      ...
      {
         IPAddress[] addresses = Dns.GetHostEntry("mail.AltimailServer.com").AddressList;
      ...
      public Domain PerformBasicSetup()
      {
         ...
         */
         ...
         AltimailServer.AntiVirus antiVirus = _settings.AntiVirus;
      ...
      */
      ...
      {
         AltimailServer.AntiSpam antiSpam = _settings.AntiSpam;
