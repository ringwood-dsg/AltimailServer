...
namespace RegressionTests.IMAP
{
   ...
   {
      private void CreateMessageModificationRule(AltimailServer.Rules ruleContainer)
      {
      ...
      private void CreateMoveRule(AltimailServer.Rules ruleContainer, string foldername)
      {
         Rule rule = ruleContainer.Add();
         rule.Name = "Criteria test";
         rule.Active = true;
