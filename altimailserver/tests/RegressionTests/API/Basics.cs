...
namespace RegressionTests.API
{
   ...
   public class Basics : TestFixtureBase
   {
      ...
      public void TestAddMessage()
      {
         ...
         for (int i = 0; i < 3; i++)
         {
            AltimailServer.Message message = folder.Messages.Add();
      ...
      public void TestAddTextToEmptyBody()
      {
         ...
         AltimailServer.Message message =
      ...
      public void TestCopyMessage()
      {
         ...
         for (int i = 0; i < 3; i++)
         {
            AltimailServer.Message message = someOtherFolder.Messages[i];
      ...
      public void TestRetrieveMessageID()
      {
         ...
         AltimailServer.Message message = account.IMAPFolders.get_ItemByName("INBOX").Messages[0];
      ...
      public void TestSaveMessageInPublicIMAPFolder()
      {
         ...
         // Send a message to the account.
         AltimailServer.Message message = testFolder.Messages.Add();
