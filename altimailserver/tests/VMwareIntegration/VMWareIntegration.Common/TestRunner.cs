   ...
   public class TestRunner
   {
      ...
      private void CopyLocalVersion(VMware vm)
      {
         ...
         var localExecutable = Path.Combine(currentDir,
            @"..\..\..\..\..\..\source\Server\hMailServer\x64\Release\AltimailServer.exe");
         ...
         vm.CopyFileToGuest(localExecutable, @"C:\Program Files\hMailServer\Bin\AltimailServer.exe");
